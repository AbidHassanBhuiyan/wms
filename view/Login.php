...
<div class="container">
  ...
  <form action="/wms/controllers/LoginAction.php" method="post" onsubmit="return validateLogin(this)">
  ...
  <p><a href="/wms/view/ForgotPassword.php">Forgot Password?</a></p>
  <p>Don't have an account? <a href="/wms/view/Register.php">Register here</a></p>
</div>
</body>
</html>